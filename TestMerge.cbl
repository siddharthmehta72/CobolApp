  IDENTIFICATION DIVISION.
       ...
       FILE-CONTROL.
           ...
           SELECT  FILEPAY1 ASSIGN TO 'FILEPAY1.TXT'
               ORGANIZATION IS LINE SEQUENTIAL.
           SELECT  FILEMPAY ASSIGN TO 'FILEMPAY.TXT'
               ORGANIZATION IS LINE SEQUENTIAL.
       DATA DIVISION.
       FILE SECTION.
       FD  FILEPAY
       ...
       LB-20.
           ...
           IF FILEHFILEID NOT EQUAL TO 'FL1'
               ...
               GO TO LB-EXIT.
           IF FILEHFILEDT NOT = UW01APRWDAYR
               DISPLAY 'DATE MISMATCH FILE1' UPON PRINTER
               DISPLAY 'UW01APRWDAYR   -----   ' UW01APRWDAYR.
       LB-30.
       ...
       LB-50.
           ...
           IF FILE1HFILE1ID NOT EQUAL TO 'FL2'
               ...
               GO TO LB-EXIT.
           IF FILE1HFILE1DT NOT = UW01APRWDAYR
               DISPLAY 'DATE MISMATCH FILE2' UPON PRINTER.
       LB-60.
